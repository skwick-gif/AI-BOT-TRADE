...
Namespace Samples
    ...
    Public Class OrderSamples
        ...
        Public Shared Function LimitOrderWithCustomerAccount(action As String, quantity As Decimal, limitPrice As Double, customerAccount As String) As Order
        ...
        Public Shared Function OrderCancelWithManualTime(manualOrderCancelTime As String) As OrderCancel
            '! [order_cancel_with_manual_order_time]
            Dim orderCancel As OrderCancel = New OrderCancel
