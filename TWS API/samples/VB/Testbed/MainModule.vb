...
Module MainModule
    ...
    Sub Main()
        ...
        socketClient.SetConnectOptions("+PACEAPI")
    ...
    Private Sub tickDataOperations(client As EClientSocket)
        ...
        client.reqMktData(1017, ContractSamples.etf(), "mdoff,577,614,623", False, False, Nothing)
        '! [reqetfticks]
    ...
    Private Sub optionsOperations(client As EClientSocket)
        ...
        '! [exercise_options]
        '** Exercising options ***
        client.exerciseOptions(5003, ContractSamples.OptionWithTradingClass(), 1, 1, Nothing, 1, "20231018-12:00:00", "CustAcct", True)
        '! [exercise_options]
    End Sub
    ...
    Private Sub orderOperations(client As EClientSocket, nextOrderId As Integer)
        ...
        client.cancelOrder(nextOrderId - 1, OrderSamples.OrderCancelWithManualTime("20240614-00:00:09"))
        '! [cancel_order_with_manual_order_cancel_time]
    ...
    Private Sub whatIfSamples(client As EClientSocket, nextOrderId As Integer)
        ...
        '! [whatiforder]
        client.placeOrder(increment(nextOrderId), ContractSamples.BondWithCusip(), OrderSamples.WhatIfLimitOrder("BUY", 100, 20))
        '! [whatiforder]
    End Sub
