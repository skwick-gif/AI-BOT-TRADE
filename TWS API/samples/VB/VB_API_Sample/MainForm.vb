...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmdReqCurrentTimeInMillis.Location = New System.Drawing.Point(543, 495)
...
#Region "Member variables"
    ...
    Private m_orderCancel As IBApi.OrderCancel
...
#Region "Form event handlers"
    ...
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        m_orderCancel = New IBApi.OrderCancel
...
#Region "Control event handlers"
    ...
    Private Sub cmdConnect_Click(sender As Object, e As EventArgs) Handles cmdConnect.Click
        ...
        If m_dlgConnect.ok Then
            With m_dlgConnect
                ...
                m_Tws.Connect(.hostIP, .port, .clientId, False, m_dlgConnect.connectOptions, m_dlgConnect.optCaps)
    ...
    Private Sub cmdCancelOrder_Click(sender As Object, e As EventArgs) Handles cmdCancelOrder.Click
        ...
        m_dlgOrder.ShowDialog()
        If m_dlgOrder.ok Then
            m_api.cancelOrder(m_dlgOrder.orderId, m_orderCancel)
        End If
    End Sub
    ...
    Private Sub cmdExerciseOptions_Click(sender As Object, e As EventArgs) Handles cmdExerciseOptions.Click
        ...
        If m_dlgOrder.ok Then
            ...
            m_api.exerciseOptions(m_dlgOrder.orderId, m_contractInfo,
                            ...
                            m_orderInfo.Account, m_dlgOrder.exerciseOverride, m_dlgOrderAttribs.getManualOrderTime(), m_dlgOrderAttribs.getCustomerAccount(),
                            m_dlgOrderAttribs.getProfessionalCustomer())
        End If
    ...
    Private Sub cmdExtendedOrderAtribs_Click(sender As Object, e As EventArgs) Handles cmdExtendedOrderAtribs.Click
        m_dlgOrderAttribs.init(Me, m_orderInfo, m_orderCancel)
...
#Region "API event handlers"
    ...
    Private Sub Api_contractDetails(sender As Object, e As ContractDetailsEventArgs) Handles m_apiEvents.ContractDetails
        ...
        m_utils.addListItem(Utils.ListType.ServerResponses, "  lastTradeDateOrContractMonth = " & contract.LastTradeDateOrContractMonth)
        m_utils.addListItem(Utils.ListType.ServerResponses, "  lastTradeDate = " & contract.LastTradeDate)
        ...
        If (contract.SecType = "FUND") Then
            m_utils.addListItem(Utils.ListType.ServerResponses, "Fund Details:")
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundName = " & contractDetails.FundName)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundFamily = " & contractDetails.FundFamily)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundType = " & contractDetails.FundType)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundFrontLoad = " & contractDetails.FundFrontLoad)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundBackLoad = " & contractDetails.FundBackLoad)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundBackLoadTimeInterval = " & contractDetails.FundBackLoadTimeInterval)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundManagementFee = " & contractDetails.FundManagementFee)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundClosed = " & contractDetails.FundClosed)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundClosedForNewInvestors = " & contractDetails.FundClosedForNewInvestors)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundClosedForNewMoney = " & contractDetails.FundClosedForNewMoney)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundNotifyAmount = " & contractDetails.FundNotifyAmount)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundMinimumInitialPurchasey = " & contractDetails.FundMinimumInitialPurchase)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundSubsequentMinimumPurchase = " & contractDetails.FundSubsequentMinimumPurchase)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundBlueSkyStates = " & contractDetails.FundBlueSkyStates)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundBlueSkyTerritories = " & contractDetails.FundBlueSkyTerritories)
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundDistributionPolicyIndicator = " & CFundDistributionPolicyIndicator.getFundDistributionPolicyIndicatorName(contractDetails.FundDistributionPolicyIndicator))
            m_utils.addListItem(Utils.ListType.ServerResponses, "  fundAssetType = " & CFundAssetType.getFundAssetTypeName(contractDetails.FundAssetType))
        End If
        ...
        m_utils.addListItem(Utils.ListType.ServerResponses, "  ineligibilityReasonList={")
        Dim ineligibilityReasonList = contractDetails.IneligibilityReasonList
        If (Not ineligibilityReasonList Is Nothing) Then
            For Each ineligibilityReason In ineligibilityReasonList
                m_utils.addListItem(Utils.ListType.ServerResponses, "    [id: " & ineligibilityReason.Id & ", description: " & ineligibilityReason.Description & "]")
            Next
        End If
        m_utils.addListItem(Utils.ListType.ServerResponses, "  }")
...
#Region "Helper methods"
    ...
    Private Sub appendOrderFields(contract As Contract, order As Order, orderState As OrderState)
        ...
        If Util.IsPegBenchOrder(order.OrderType) Then
