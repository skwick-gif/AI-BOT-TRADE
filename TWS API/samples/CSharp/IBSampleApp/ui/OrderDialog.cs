    ...
    partial class OrderDialog : Form
    {
        ...
        public void HandleOpenOrder(OpenOrderMessage openOrderMessage)
        {
            if (openOrderMessage.Order.WhatIf)
                marginDialog.UpdateMarginInformation(openOrderMessage.OrderState, openOrderMessage.Order);
        }
        ...
        private OrderCancel GetOrderCancel()
        {
            ...
            FillExtendedOrderCancelAttributes(orderCancel);
            return orderCancel;
        }
        ...
        private void FillAdvisorAttributes(Order order)
        {
            ...
            order.FaMethod = faMethod.SelectedItem != null ? (string)((IBType)faMethod.SelectedItem).Value : "";
        }
        ...
        private void cancelOrderButton_Click(object sender, EventArgs e)
        {
            ...
            orderManager.CancelOrder(order, orderCancel);
            if (orderId != 0)
                orderId = 0;
            Visible = false;
        }
