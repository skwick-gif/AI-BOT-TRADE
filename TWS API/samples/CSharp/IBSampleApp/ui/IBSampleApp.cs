...
namespace IBSampleApp
{
    partial class IBSampleAppDialog : Form
    {
        ...
        private void exerciseOption_Click(object sender, EventArgs e)
        {
            ...
            string manualOrderTime = optionManualOrderTime.Text;
            string customerAccount = optionCustomerAccount.Text;
            bool professionalCustomer = optionProfessionalCustomer.Checked;
            optionsManager.ExerciseOptions(ovrd, int.Parse(optionExerciseQuan.Text), exchange, 1, manualOrderTime, customerAccount, professionalCustomer);
        }
        ...
        private void lapseOption_Click(object sender, EventArgs e)
        {
            ...
            string customerAccount = optionCustomerAccount.Text;
            bool professionalCustomer = optionProfessionalCustomer.Checked;
            optionsManager.ExerciseOptions(ovrd, int.Parse(optionExerciseQuan.Text), exchange, 2, manualOrderTime, customerAccount, professionalCustomer);
        }
