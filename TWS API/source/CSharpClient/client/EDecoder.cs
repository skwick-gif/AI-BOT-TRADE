...
namespace IBApi
{
    internal class EDecoder : IDecoder
    {
        ...
        private void OpenOrderEventProtoBuf(int len)
        {
            ...
            Order order = EDecoderUtils.decodeOrder(openOrderProto.Contract, openOrderProto.Order);
        ...
        private void ExecutionDataEventProtoBuf(int len)
        {
            ...
            int reqId = executionDetailsProto.HasReqId ? executionDetailsProto.ReqId : 0;
        ...
        private void ExecutionDataEndEventProtoBuf(int len)
        {
            ...
            int reqId = executionDetailsEndProto.HasReqId ? executionDetailsEndProto.ReqId : 0;
