...
namespace TWSLib
{
    ...
    public interface ITwsEvents
    {
        ...
        [DispId(123)]
        void securityDefinitionOptionParameter(int reqId, string exchange, int underlyingConId, string tradingClass, string multiplier, string expirations, string strikes);
        [DispId(124)]
